...
df_plot2  %>% 
  ...
  labs(title="COVID-19 Cases per one million inhabitants", subtitle="Generated by @seyhunsaral based on an idea by @hrnzkan.
\nInspired by @jburnmurdoch's plot on https://www.ft.com/coronavirus-latest.\nEducational purposes only. Not associated with FT or any other institution.
 \nCOVID Data: COVID-19 (2019-nCoV) Data Repository by Johns Hopkins CSSE \nPopulation Data: JohnSnowLabs\n  ")
